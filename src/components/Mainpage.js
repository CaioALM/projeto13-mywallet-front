...
export default function Mainpage (){
    ...
    useEffect(() => {
            const promise = axios.get("https://back-mywallet77.herokuapp.com/mainpage", {
    ...
    function mainData(){
        ...
        return(
                ...
                (registers[0].length === 0) ? (
                    ...
                    <CashFlux> {registers[0].map((register, item) => {
    ...
    return(
        ...
        <Container>
            ...
            <Footer>
                <StyledLink to="/inFlux"><ion-icon name="add-circle-outline"></ion-icon> Nova entrada</StyledLink>
                <StyledLink to="/outFlux"><ion-icon name="remove-circle-outline"></ion-icon> Nova saída</StyledLink>
            </Footer>
        </Container>
        </>
    )
